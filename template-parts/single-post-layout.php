    ...
    <?php if(has_post_thumbnail()) { ?>
        ...
        if ( is_singular( 'attachment' ) ) {
            ...
            the_post_navigation( array(
                'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'vw-painter' ),
            ) );
        } elseif ( is_singular( 'post' ) ) {
            // Previous/next post navigation.
            the_post_navigation( array(
                'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'vw-painter' ) . '</span> ' .
                    '<span class="screen-reader-text">' . __( 'Next post:', 'vw-painter' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
                'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'vw-painter' ) . '</span> ' .
                    '<span class="screen-reader-text">' . __( 'Previous post:', 'vw-painter' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
            ) );
        }
    ?>

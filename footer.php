...
<div  id="footer" class="copyright-wrapper">
    <div class="container">
        ...
        ?>
		 <div class="col-xs-12 footer-block full-width-block">
...
<div id="footer-2">
  	<div class="copyright container">
        <p><?php echo esc_html(get_theme_mod('vw_painter_footer_text',__('Copyright 2018 -','vw-painter'))); ?> </p>
        <?php if( get_theme_mod( 'vw_painter_hide_show_scroll',true) != '') { ?>
            <?php $theme_lay = get_theme_mod( 'vw_painter_scroll_top_alignment','Right');
            if($theme_lay == 'Left'){ ?>
                <a href="#" class="scrollup left"><i class="ion-ios-arrow-up"></i></a>
            <?php }else if($theme_lay == 'Center'){ ?>
                <a href="#" class="scrollup center"><i class="ion-ios-arrow-up"></i></a>
            <?php }else{ ?>
